export function StylishButton({
  ...
  return (
    ...
    >
      <span className='w-0 h-full rounded bg-purple-600 absolute top-0 left-0 ease-out duration-500 transition-all group-hover:w-full group-hover:h-full -z-1'></span>
